                    ...
                    <div className="max-w-2xl mx-auto text-center space-y-6">
                        ...
                        <motion.div variants={itemAnimation} className="space-y-2">
                            <h2 className="text-3xl md:text-4xl font-bold text-primary">
                                Operating Inside Real Systems
                            </h2>
                            <p className="text-lg text-muted-foreground">
                                Roles where correctness, reliability, and tradeoffs mattered more than feature velocity.
                            </p>
                        </motion.div>
                    </div>
                                        ...
                                        <div className="flex-1 pb-8">
                                            <div className="bg-black border border-white/30 rounded-2xl p-6 backdrop-blur-md shadow-[0_4px_6px_rgba(0,0,0,0.5),0_0_10px_rgba(255,255,255,0.05)] hover:border-white/60 transition-all duration-300 group relative overflow-hidden hover:shadow-[0_4px_6px_rgba(0,0,0,0.5),0_0_20px_rgba(255,255,255,0.1)]">
                                                ...
                                                <div className="relative z-10">
                                                    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-3 mb-4">
                                                        <div>
                                                            ...
                                                            <p className={`font-medium ${
                                                                exp.company === 'GeeksforGeeks KIIT' ? 'text-green-500' :
                                                                exp.company === 'IoT Lab, KIIT' ? 'text-sky-400' :
                                                                'text-primary/80'
                                                            }`}>
                                                                {exp.company}
                                                            </p>
                                                    ...
                                                    {/* Description reframed as system context */}
                                                    {exp.description && (
                                                    ...
                                                    {/* Responsibilities = decisions & ownership */}
                                                    ...
                                                    {/* Technologies as tools, not identity */}
